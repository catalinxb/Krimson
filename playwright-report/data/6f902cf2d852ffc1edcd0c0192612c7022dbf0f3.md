...
- Name: trading-app.spec.js >> Authentication Flow >> should navigate to landing after login
- Location: e2e\trading-app.spec.js:4:3
...
Locator: locator('p').filter({ hasText: 'Advanced Trading Terminal' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('p').filter({ hasText: 'Advanced Trading Terminal' })
...
```yaml
- generic [ref=e6]:
  - paragraph [ref=e8]: Trading Journal
  - generic [ref=e10]:
